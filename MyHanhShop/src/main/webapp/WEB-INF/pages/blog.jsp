					...
					<div class="recent-post">
						...
						<div class="recent-blog">
							<a href="#" class="rb-item">
								<div class="rb-pic">
									<img
										src="${pageContext.request.contextPath}/statics/img/blog/recent-1.jpg"
										alt="">
								</div>
								<div class="rb-text">
								...
								<div class="rb-pic">
									<img
										src="${pageContext.request.contextPath}/statics/img/blog/recent-2.jpg"
										alt="">
								</div>
								<div class="rb-text">
									<h6>The Personality Trait That Makes...</h6>
								...
								<div class="rb-pic">
									<img
										src="${pageContext.request.contextPath}/statics/img/blog/recent-3.jpg"
										alt="">
								</div>
								<div class="rb-text">
									<h6>The Personality Trait That Makes...</h6>
								...
								<div class="rb-pic">
									<img
										src="${pageContext.request.contextPath}/statics/img/blog/recent-4.jpg"
										alt="">
								</div>
								<div class="rb-text">
									<h6>The Personality Trait That Makes...</h6>
			...
			<div class="col-lg-9 order-1 order-lg-2">
				<div class="row">
					<div class="col-lg-6 col-sm-6">
						<div class="blog-item">
							<div class="bi-pic">
								<a href="/MyHanhShop/blog/blogDetail/"><img
									src="${pageContext.request.contextPath}/statics/img/blog/blog-1.jpg"
									alt=""></a>
							</div>
							<div class="bi-text">
								<a href="/MyHanhShop/blog/blogDetail/">
					...
					<div class="col-lg-6 col-sm-6">
						<div class="blog-item">
							<div class="bi-pic">
								<img
									src="${pageContext.request.contextPath}/statics/img/blog/blog-2.jpg"
									alt="">
							</div>
							<div class="bi-text">
								<a href="/MyHanhShop/blog/blogDetail/">
					...
					<div class="col-lg-6 col-sm-6">
						<div class="blog-item">
							<div class="bi-pic">
								<img
									src="${pageContext.request.contextPath}/statics/img/blog/blog-3.jpg"
									alt="">
							</div>
							<div class="bi-text">
								<a href="/MyHanhShop/blog/blogDetail/">
					...
					<div class="col-lg-6 col-sm-6">
						<div class="blog-item">
							<div class="bi-pic">
								<img
									src="${pageContext.request.contextPath}/statics/img/blog/blog-4.jpg"
									alt="">
							</div>
							<div class="bi-text">
								<a href="/MyHanhShop/blog/blogDetail/">
					...
					<div class="col-lg-6 col-sm-6">
						<div class="blog-item">
							<div class="bi-pic">
								<img
									src="${pageContext.request.contextPath}/statics/img/blog/blog-5.jpg"
									alt="">
							</div>
							<div class="bi-text">
								<a href="/MyHanhShop/blog/blogDetail/">
					...
					<div class="col-lg-6 col-sm-6">
						<div class="blog-item">
							<div class="bi-pic">
								<img
									src="${pageContext.request.contextPath}/statics/img/blog/blog-6.jpg"
									alt="">
							</div>
							<div class="bi-text">
								<a href="/MyHanhShop/blog/blogDetail/">
